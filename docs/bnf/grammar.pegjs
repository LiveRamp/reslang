...
namespacedefinition = comment:description? "namespace" "{"
...
operation = operation:ops errors: errors* ";"? {
...
attributes = attrs:attribute+ { return attrs; }
attribute = comment:description? name:name ":"
