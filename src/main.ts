...
const args = yargs
    ...
    .option("oneof-polymorphism", {
        type: "boolean",
        describe:
            "Use the oneof polymorphism approach for Ruby codegen. It is backwards compatible over the wire with the original discriminator-mappings approach."
    })
    .option("jsonschema", {
        type: "string",
        describe:
